...
### Code Quality
- [ ] **Increase test coverage from 72% to 90%+** (HIGH PRIORITY - see [Coverage Report](docs/COVERAGE_REPORT.md))
- [ ] Fix failing tests and ensure all tests pass
- [ ] Expand live authenticated smoke coverage for account-bound tools
- [ ] Add integration tests for all tool families
...
### For Developers
1. **Pick an issue** from our [GitHub Issues](https://github.com/IgnazioDS/Substak-MCP/issues)
...
*Have ideas not listed here? Open a [discussion](https://github.com/IgnazioDS/Substak-MCP/discussions) and let's talk!*
